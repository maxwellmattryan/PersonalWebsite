                    ...
                    <div className="footer-text-container">
                        ...
                        <div id="resume-about" className="resume-section">
                            ...
                            <p className="resume-section-description">
                                I'm a passionate front-end developer who enjoys building websites and web 
                                applications. The both creative and technical challenges of web development
                                make the experience fun and worthwhile.
                            </p>
                        </div>
                        ...
                        <div id="resume-skills" className="resume-section">
                            ...
                            <p className="resume-section-description">
                                Front-End: <i>HTML 5, CSS 3, Javascript, jQuery, React JS</i>
                                <br/>
                                <br/>
                                Development: <i>NodeJS, Visual Studio Code, Sass, Git, GitHub</i>
                                <br/>
                                <br/>
