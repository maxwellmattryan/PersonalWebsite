        ...
        return(
            <div className="about-container animated">
                <div className="about-text-container">
                    ...
                    <p>
                        Now, I am applying all of that knowledge with my design skills to build and develop professional-grade web applications as well as other various personal 
