...
VALUES (2,
       ...
       'I''m a software engineer based in Austin, TX. I love to build and develop software as it relates to audio, such as effect and synthesis plugins, digital signal processing, video game audio, microchip, and more.',
...
VALUES (2,
       ...
       'I strive to develop both immersive audio and clean and neatly architectured code for video games. This pertains to things such as systems, mechanics, mechanics, audio implementation, and more. I find the fact that each and every game is different is what makes the entire process so enjoyable and informative.',
       'assets/images/profiles/portrait.png');
INSERT INTO profile(status_id, name, tagline, landing, about, image_url)
VALUES (1,
